...
## 🎉 新闻
**🔥 我们的论文已被[ICIG 2026](https://icig.csig.org.cn/)接收!**

本仓库是我们论文的官方实现，**提出了一种在VAE潜在空间中利用频域嵌入的鲁棒图像水印新方法**

## 🔍 概述

![架构图](Image/Overview.png)
...
### 设置环境
```bash
git clone https://github.com/lin-zk/RobustLatentDiscreteCosineTransformDomainImageWatermarking
cd RobustLatentDiscreteCosineTransformDomainImageWatermarking
conda create --name envPy38 python=3.8
...
```
RobustLatentDiscreteCosineTransformDomainImageWatermarking/
...
- **几何攻击**：缩放变换、旋转变换（需额外噪声层）、裁剪变换（需额外噪声层）
...
- **Watermark Attacker**：用于攻击测试 [[Zhao et al., NeurIPS 2024]](https://github.com/xuandongzhao/watermarkattacker)
